注：除此文档外我不打算改变任何文件，所以请仔细阅读本文档说明
感谢git上共享的BasicWinAPI-master的项目，你应该搜索的到原作者
15.17两个文件编译有些不同.15的后缀名为cpp可以通过编译．17大约是用了opengl的库，
我没装所以不知道是否能编译成功．
别的都通过编译了，如果你用的是新版的mingw_w64．应该不需要如楼下原文所说的编译了
编译命令：
gcc -Wall filename.c -mwindows  -o filename.exe
以下为原文：
